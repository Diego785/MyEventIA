                ...
                <div x-show.transition="step != 'complete'">
                    ...
                    <div class="border-b-2 py-4">
                        ...
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                            <div class="flex-1">
                                <div x-show="step === 1">
                                    <div class="text-lg font-bold text-gray-700 leading-tight">Tu Perfil</div>
                                </div>

                                <div x-show="step === 2">
                                    <div class="text-lg font-bold text-gray-700 leading-tight">Tu Contraseña</div>
                                </div>

                                <div x-show="step === 3">
                                    <div class="text-lg font-bold text-gray-700 leading-tight">Suscripción
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="py-10">
                        <div x-show.transition.in="step === 1">
                            <div class="mb-5 text-center">
                                ...
                                <div class="mx-auto w-48 text-gray-500 text-xs text-center mt-1">Click aquí para
                                    adicionar una foto</div>
                            ...
                            <div class="mb-5">
                                <label for="firstname" class="font-bold mb-1 text-gray-700 block">Nombre de
                                    Usuario</label>
                            ...
                            <div class="mb-5">
                                <label for="telephone" class="font-bold mb-1 text-gray-700 block">Celular</label>
                            ...
                            <div class="mb-5">
                                <label for="email" class="font-bold mb-1 text-gray-700 block">Correo
                                    Electrónico</label>
                        ...
                        <div x-show.transition.in="step === 2">
                            ...
                            <div class="mb-5">
                                <label for="password" class="font-bold mb-1 text-gray-700 block">Registra tu
                                    contraseña</label>
                                <div class="text-gray-600 mt-2 mb-4">
                                    Por favor crea una contraseña segura siguiendo los criterios de abajo.
                                ...
                                <div class="relative">
                                    <input :type="togglePassword ? 'text' : 'password'"
                                        @keydown="checkPasswordStrength()" wire:model="password"
                                        class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                        ...
                        <div x-show.transition.in="step === 3">
                            ...
                            <div class="mb-5">
                                <label for="carnet" class="font-bold mb-1 text-gray-700 block">Carnet de
                                    Identidad</label>
                                <input wire:model="carnet"
                                    class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                                    placeholder="Ejm: 7777326">
                            </div>
                            <x-jet-input-error for="carnet" class="mb-1 " />

                            @livewire('system.registering-payment', ['amount' => $amount, 'namePh' => $name, 'emailPh' => $email, 'passwordPh' => $password, 'carnetPh' => $carnet])
                            <x-jet-input-error for="suscription" class="mb-1 " />
                    ...
                    <div class="flex justify-between">
                        ...
                        <div class="w-1/2 text-right">
                            @if ($name == '' || $email == '' || $telephone == '')
                                <button disabled x-show="step < 3" @click="step++"
                                    class="w-32 focus:outline-none border border-transparent py-2 px-5 rounded-lg shadow-sm text-center text-white bg-gray-500 hover:bg-gray-600 font-medium">Siguiente</button>
                            @else
                            ...
                            <button wire:click="savePhotographerUser()" x-show="step === 3"
